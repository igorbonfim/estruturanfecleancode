Pequeno exemplo contendo a estruturação básica de um sistema de NF-e(Nota fiscal eletrônica). A interface gráfica é simples, não sendo exatamente uma típica tela de NF-e. 
